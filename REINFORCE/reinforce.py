...
class REINFORCEAGENT(object):
    ...
    def calculate_loss(self):
        ...
        policy_losses = (-log_probs * returns) # maximize reward = minimize negative reward
...
def train(lr=0.01):
    ...
    reinforceAgent = REINFORCEAGENT(observation_dim, action_dim, gamma, hidden_size, lr_ac)
    ...
    plt.savefig('REINFORCE_plot-whole.png')
    #plt.show()
