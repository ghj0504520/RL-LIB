...
for episode in range(total_episodes):
    ...
    while not done:
        ...
        sarsaAgent.update(state1, action1, reward, state2, action2)
...
plt.plot(range(1, num_chunks + 1), average_rewards, label='SARSA AVG Reward per 100 Episodes', color='b', marker='o')
...
plt.savefig('SARSA_reward_plot.png')
